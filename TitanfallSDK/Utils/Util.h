...
#define PD2HOOK_LOG_LEVEL_SHORT(msg, level) do { \
...
#define PD2HOOK_LOG_LOG(msg) PD2HOOK_LOG_LEVEL_SHORT(msg, pd2hook::Logging::LogType::LOGGING_LOG)
#define PD2HOOK_LOG_LUA(msg) PD2HOOK_LOG_LEVEL_SHORT(msg, pd2hook::Logging::LogType::LOGGING_LUA)
